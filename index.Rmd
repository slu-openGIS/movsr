...
This site offers an [initial analyses](articles/analysis-2017-vehicle-stops.html) of the 2017 vehicle stop report data for St. Louis City and County.

## For Researchers
This site offers a walk through in the [Get started article](articles/movsr.html) for using `movsr` for scraping and formatting vehicle stop data as well as [documentation](reference/index.html) for project specific functions.
