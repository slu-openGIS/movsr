...
# data
load(system.file("extdata", "data2017", package = "movsr"))
```
...
Our first plot compares the African American proportion of stopped motorists to the disparity index value for each of the 53 police departments included in our sample. We can see that there is some wide variation - we have a number of departments with *very* high disparity index values, 
